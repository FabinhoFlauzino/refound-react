...
export function Confirm() {
  ...
  return (
    <div className="bg-gray-500 lg-w[512px] rounded-xl flex flex-col items-center p-10 gap-6">
      ...
      <img src={okSvg} alt="Icone de sucesso" className="w-28" />
      <p className="text-sm text-gray-200 text-center">Agora é apenas aguardar! Sua solicitação será analisada e,
        em breve , o setor financeiro irá entrar em contato com você!</p>
